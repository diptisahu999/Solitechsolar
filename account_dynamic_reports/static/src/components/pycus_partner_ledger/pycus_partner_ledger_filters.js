...
export class PycusPartnerLedgerFilters extends PycusFilters {
    setup(){
        ...
        this.toggleAllPartners = () => {
            this.state.all_partners = !this.state.all_partners;
            if (this.state.all_partners) {
                // If 'All Partners' is selected, clear the partner tags selection
